            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'Pandemonium-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Cshark GitHub Repo](https://github.com/Cshark/)  

🚀 _Thanks for choosing PANDEMONIUM-MD — Let the automation begin!_ ✨`;
